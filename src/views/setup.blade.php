...
<script type="text/javascript">
    ...
    var field_group_list_template_url = "{{URL::asset($attribute_pkg_prefix.'/public/themes/'.$theme.'/attribute-pkg/field-group/list.html')}}";
    // var field_group_list_url = "{{url('#!/attribute-pkg/field-group/list')}}";
    var field_group_form_template_url = "{{URL::asset($attribute_pkg_prefix.'/public/themes/'.$theme.'/attribute-pkg/field-group/form.html')}}";
