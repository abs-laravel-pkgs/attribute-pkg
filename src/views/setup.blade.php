...
<script type="text/javascript">
    ...
    var field_list_template_url = "{{URL::asset($attribute_pkg_prefix.'/public/angular/attribute-pkg/pages/field/list.html')}}";
    var field_list_url = "{{url('#!/attribute-pkg/field/list')}}";
    var field_form_template_url = "{{URL::asset($attribute_pkg_prefix.'/public/angular/attribute-pkg/pages/field/form.html')}}";
...
<script type="text/javascript" src="{{URL::asset($attribute_pkg_prefix.'/public/angular/attribute-pkg/pages/field/controller.js?v=2')}}"></script>
